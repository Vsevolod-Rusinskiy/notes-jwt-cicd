...
export class AuthController {
    ...
    @ApiBody({ description: 'Provide the refresh token', type: 'object', required: true })
    @Post('logout')
    ...
    @ApiBody({ description: 'Provide the refresh token to get a new access token', type: 'object', required: true })
    @Post('refresh')
